...
const Ficcion = () => {
  return (
    <div>
      <BannerContainer>
        <img
          src="https://preview.redd.it/contsthf3ic71.png?width=1500&format=png&auto=webp&s=720c1cb5b3ff208750c1d2bfa1d5fbe8c5b71560"
          alt="Banner Ciencia ficcion"
        />
      </BannerContainer>
      <TituloContainer>
      ...
      <ListaPeliculas>
        {cienciaFiccion.map((ficcion) => (
          <Card key={ficcion.id}>
            <Link to={`/pelicula/${ficcion.id}`}>
